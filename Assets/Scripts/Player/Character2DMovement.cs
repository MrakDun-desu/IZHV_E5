...
public class Character2DMovement : MonoBehaviour
{
    ...
    void AnimateCharacter()
    {
	    ...
	    animator.SetFloat(AnimatorMoveSpeed, moveSpeed);
	    animator.SetBool(AnimatorJump, jump);
	    animator.SetBool(AnimatorGrounded, grounded);
	    animator.SetBool(AnimatorCrouch, crouch);
	    animator.SetBool(AnimatorFall, falling);
    }
}
